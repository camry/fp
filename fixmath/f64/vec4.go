...
func Vec4FromRaw(rawX, rawY, RawZ, RawW int64) Vec4 {
    return Vec4{
        RawX: rawX,
        RawY: rawY,
        RawZ: RawZ,
...
func Vec4FromFloat64(x, y, z, w float64) Vec4 {
    return Vec4FromRaw(fix64.FromFloat64(x), fix64.FromFloat64(y), fix64.FromFloat64(z), fix64.FromFloat64(w))
}

// Vec4Min returns the smallest Vec4 that was passed in the arguments.
//
...
func Vec4Min(v0 Vec4, v1 Vec4) Vec4 {
...
// Vec4Max returns the largest Vec4 that was passed in the arguments.
//
// To call this function with an array, you must do:
//
//     Vec4Max(v0, v1)
...
func Vec4Max(v0 Vec4, v1 Vec4) Vec4 {
...
func (v Vec4) Length() F64 {
    return FromRaw(fix64.Sqrt(fix64.Mul(v.RawX, v.RawX) + fix64.Mul(v.RawY, v.RawY) + fix64.Mul(v.RawZ, v.RawZ) + fix64.Mul(v.RawW, v.RawW)))
}

func (v Vec4) LengthFast() F64 {
    return FromRaw(fix64.SqrtFast(fix64.Mul(v.RawX, v.RawX) + fix64.Mul(v.RawY, v.RawY) + fix64.Mul(v.RawZ, v.RawZ) + fix64.Mul(v.RawW, v.RawW)))
}

func (v Vec4) LengthFastest() F64 {
    return FromRaw(fix64.SqrtFastest(fix64.Mul(v.RawX, v.RawX) + fix64.Mul(v.RawY, v.RawY) + fix64.Mul(v.RawZ, v.RawZ) + fix64.Mul(v.RawW, v.RawW)))
}

func (v Vec4) LengthSqr() F64 {
    return FromRaw(fix64.Mul(v.RawX, v.RawX) + fix64.Mul(v.RawY, v.RawY) + fix64.Mul(v.RawZ, v.RawZ) + fix64.Mul(v.RawW, v.RawW))
}

func (v Vec4) Normalize() Vec4 {
    ooLen := FromRaw(fix64.RSqrt(fix64.Mul(v.RawX, v.RawX) + fix64.Mul(v.RawY, v.RawY) + fix64.Mul(v.RawZ, v.RawZ) + fix64.Mul(v.RawW, v.RawW)))
    return Vec4FromF64(ooLen, ooLen, ooLen, ooLen).Mul(v)
}

func (v Vec4) NormalizeFast() Vec4 {
    ooLen := FromRaw(fix64.RSqrtFast(fix64.Mul(v.RawX, v.RawX) + fix64.Mul(v.RawY, v.RawY) + fix64.Mul(v.RawZ, v.RawZ) + fix64.Mul(v.RawW, v.RawW)))
    return Vec4FromF64(ooLen, ooLen, ooLen, ooLen).Mul(v)
}

func (v Vec4) NormalizeFastest() Vec4 {
    ooLen := FromRaw(fix64.RSqrtFastest(fix64.Mul(v.RawX, v.RawX) + fix64.Mul(v.RawY, v.RawY) + fix64.Mul(v.RawZ, v.RawZ) + fix64.Mul(v.RawW, v.RawW)))
    return Vec4FromF64(ooLen, ooLen, ooLen, ooLen).Mul(v)
}

func (v Vec4) Dot(b Vec4) F64 {
    return FromRaw(fix64.Mul(v.RawX, b.RawX) + fix64.Mul(v.RawY, b.RawY) + fix64.Mul(v.RawZ, b.RawZ) + fix64.Mul(v.RawW, b.RawW))
}

func (v Vec4) Distance(b Vec4) F64 {
    return v.Sub(b).Length()
}

func (v Vec4) DistanceFast(b Vec4) F64 {
    return v.Sub(b).LengthFast()
}

func (v Vec4) DistanceFastest(b Vec4) F64 {
...
func (v Vec4) Lerp(b Vec4, t F64) Vec4 {
    tb := t.Raw
    ta := fix64.One - tb

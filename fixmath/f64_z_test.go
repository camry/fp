...
func TestAdd(t *testing.T) {
    f1 := fixmath.F64FromInt32(2147483647)
    f2 := fixmath.F64FromInt32(-2147483647)
    f3 := fixmath.F64FromInt64(2147483647)
    f4 := fixmath.F64FromFloat32(134.8765346)
...
func TestSub(t *testing.T) {
    f1 := fixmath.F64FromInt32(2147483647)
    f2 := fixmath.F64FromInt32(2147483123)
    f3 := fixmath.F64FromInt32(2147483647)
    f4 := fixmath.F64FromFloat64(2147483123.4523)
    assert.Equal(t, f1.Sub(f2).RoundToInt(), int32(524))
    assert.Equal(t, f3.Sub(f4).Float32(), float32(523.5477))
}

func TestMul(t *testing.T) {
    f1 := fixmath.F64FromInt32(2147483647).Mul(fixmath.F64FromFloat32(0.30))
...
func TestDiv(t *testing.T) {
    f1 := fixmath.F64FromInt32(2147483647).Div(fixmath.F64FromFloat32(4567822))
    assert.Equal(t, f1.Float32(), float32(470.13297))
}

func TestFix64(t *testing.T) {
    f1 := fixmath.F64FromInt32(300).Mul(fixmath.F64FromInt32(300)).DivPrecise(fixmath.F64FromInt32(300).Add(fixmath.F64FromInt32(10).Mul(fixmath.F64FromInt32(5).Mul(fixmath.F64FromInt32(1).Sub(fixmath.F64FromFloat32(0))))))
